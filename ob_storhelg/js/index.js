...
var date = new Date();
//variable for set dates
var nyarsdatum = new Date("December 27 2018");
var trettonhelgsdatum = new Date("January 2 2019");
var paskdatum = new Date("April 1 2019")

//handling dates:
//Check if current date is after boxing day(annandag jul)
if (date.getTime() > nyarsdatum.getTime()) {
  //check if date is also after New Years day, if it is change background image and avtalsfil to trettonhelg
  if (date.getTime() > paskdatum.getTime()) {
    ...
    // mainContent.style.backgroundImage = "url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/2076398/trettonhelg.svg')";
    goActive(helgknapp4);
    helgtext = "avtalstext4";
  }
  //if date is after boxing day but before New Years Day, change background image and avtalsfil to nyar
  // else {
  //   mainContent.style.backgroundImage = "url('https://s3-us-west-2.amazonaws.com/s.cdpn.io/2076398/nyar.svg')";
  //   goActive(helgknapp2);
  //   avtalen = nyarsavtal;
  // }
}
...
function valueToDiv() {
  ...
  var node = document.createElement('DIV');
    if (hittad === true) {
      node.innerHTML = '<p></p><p class="paddingBottom10 paddingTop10 u-textMetaDeca caps">Avtal för ' + inpValue + '</p>';
    }
    //give error message
    else {
      messagediv.innerHTML ='';
