...
function printNumber() {
    ...
    output_string += "<p>Din lön skulle behöva öka med <b>" + formatKronor.to(fiktivlon) + "</b> i dagens penningvärde för att du skulle kunna köpa lika mycket för den som i januari 2021.</p>"
