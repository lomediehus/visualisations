...
function switchTexts(array, key, index = 0) {
  ...
  let startEyes = document.querySelectorAll("#ryggpass .awake");

  // let innerCircles = document.querySelectorAll("#ryggpass .circle-inner");
  // innerCircles = [...innerCircles]
  // let innerCircleContents = document.querySelectorAll("#ryggpass .circle-inner-content");
  // innerCircleContents = [...innerCircleContents]


  console.log(startEyes)
  startEyes .forEach(circle => {
  ...
  sections.forEach(section => {
    section.addEventListener("click", function(event){
      ...
      let allEyes = document.querySelectorAll(".awake")
      allEyes = [...allEyes]
      allEyes.forEach(circle => {
      ...
      let eyes = this.querySelectorAll(".awake")
      console.log(eyes)
      eyes = [...eyes]
      // function wakeUp() {
      //   eyes.forEach(circle => {
