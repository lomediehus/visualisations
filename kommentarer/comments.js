gsap.registerPlugin(TextPlugin);
  ...
  const allakategorier = {
    ...
    arbetssatt: ["Ja, vi har längre schemaperioder inom hemtjänsten för att våra medarbetare skall kunna planera och balansera mellan arbete/privatliv.", "Ja, förändringar har skett relaterat till hur exempelvis helgpass samt arbetsplatsträffar schemaläggs.", "Vi arbetar med att införa central schemaläggning.", "Inom hemtjänst har veckor med enbart kvällspass införts, och även veckor med enbart dagspass.", "Uppdelning av APT.", "Säbo: Nattpassen har förlängts på enstaka säbo. Ryggpass finns kvar men korrigeras genom att man slutar tidigare eller börjar senare.", "Delade turer/långturer har kortats.", "Infört tredagars ledighet på vissa områden."],
