  ...
  function setFire(){
    ...
    function maketable(data) {
      ...
      data.forEach(function(row) {
        ...
        cell1.classList.add('fixed-width');
    ...
    function makeMap(data) {
      ...
      var svg = d3.select('div#brandkartdiv')
        .append('svg')
      ...
      var projection = d3.geoConicEqualArea()
          ...
          .translate([w*1.63, h/2.2]) //translate to center the map in view;
        ...
        svg.selectAll("path")
          ...
          //color and text for the legend. (Addding an extra item to the domain and range arrays will create a new legend item)
            var color = d3.scaleOrdinal()
                .domain(["Löneuppgifter finns", "Uppgifter saknas"])
                .range(["#64988b", "#9a9a9a"]);
