        ...
        success: function (data) {
          ...
          function makeMarkup(x) {
            ...
            <div id="${data[x].divid}" class="u-paddedTopM">
              ...
              <label class="smalfraga"><input type=${boxtype} name='fraga${(x+1).toString()}' value='${data[x].value3}' class='checkbox'>${data[x].alt3}<span class="symbol">  ${(data[x].value3 === "rätt") ? rättsymbol : felsymbol}</span></label><br>
              <label class="smalfraga"><input type=${boxtype} name='fraga${(x+1).toString()}' value='${data[x].value4}' class='checkbox'>${data[x].alt4}<span class="symbol">  ${(data[x].value4 === "rätt") ? rättsymbol : felsymbol}</span></label>
