...
document.addEventListener("DOMContentLoaded", function() {
    ...
    Promise.all([map]).then(function(values) {
        ...
        var datafile = d3.json("minicase.json");
        ...
        Promise.all([datafile]).then(function(values) {
            ...
            .each(function(d) {
                ...
                // Add citat label using foreignObject for easy text wrapping
                if (d.citat) {
                    group.append("foreignObject")
                        ...
                        .attr("height", 100)
                        .append("xhtml:div")
                        .attr("class", "label-citat")
                        .style("font-size", "16px")
                        .on("click", clicked)
                        // .style("line-height", "0.5")
                        // .html(d.citat)
                        .html("<p class='BodyImage-caption litenofet'>" +d.ort +"</p>" + d.citat);
