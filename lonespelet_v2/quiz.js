    ...
    },
    {
        fraga: function () {
            ...
            if (lonekrav - arbetsgivarkrav <= 0.5) {
                ...
                output = ["Klappat och klart","<p>Arbetsgivarna ger med sig och möter ditt krav på " + formatPercent.to(lonekrav) + ". Strejken är alltså över.</p><p> Nationalekonomerna ger godkänt betyg till uppgörelsen, men många medlemmar är missnöjda med nivån som ger en rejäl reallönesäkning med tanke på den höga inflationen.</p>"];
            } else {
                if (strejkdagar == 0) {
                    arbetsgivarkrav += 0.5;
                    output = ["Storstrejk!","<p>Strejken inleds. Industrierna står still och företagen förlorar mycket pengar. Arbetsgivarna rasar över fackets nonchalans inför den svenska konkurrenskraften.</p><p>För att få ett slut på strejken går de till slut med på att sockra budet med ytterligare 0,5 procentenheter, till " + formatPercent.to(arbetsgivarkrav) + ".</p><p>Vad gör du?</p>"];
