...
var introText = "Här är lite text om testet";
...
var questions = [
    ...
    {
        fraga: "<p>Helena Helmersson. Sommaren 2023 granskade Aftonbladet H&Ms insamlingsverksamhet för begagnade kläder. Resultatet visade att vissa av de insamlade kläderna hamnade på några av jordens värsta dumpningsplatser i länder som Uganda och Benin.</p><p>Trots att kläderna utrustats med spårare och att tidningen både hade ögonvittnen och bildmaterial som bevis så vägrade Helena Helmersson att erkänna detta hade hänt i en intervju i TV4. Aftonbladets granskning vann senare stora journalistpriset.</p>",
        alternativ: [fortsätt],
        rattSvar: "",
        bild: "bilder/elon.jpeg",
        explainer: "",
        meddelande: true,
    },
    {
    ...
    {
        fraga: "Richard och Christoffer Bergfors. I ett nyhetsbrev till sina anställda inför valet 2014 varnade bröderna sin personal för att rösta på Socialdemokraterna, något som av flera anställda uppfattades som ett förtäckt hot.",
        alternativ: [fortsätt],
        rattSvar: "",
        bild: "bilder/elon.jpeg",
        explainer: "",
    ...
    {
        fraga: "Gudrun Sjödén. Efter en granskning av arbetsmiljön på modeföretaget Gudrun Sjödén valde grundaren hösten 2022 att lämna Sverige. I en intervju med Expressen samma månad kritiserade hon systemet i Sverige för vara allt för löntagarorienterat.",
        alternativ: [fortsätt],
        rattSvar: "",
        bild: "bilder/elon.jpeg",
        explainer: "",
    ...
    {
        fraga: "Elon Musik svarar kort och koncist om vad han anser om IF Metalls strejk mot Tesla i Sverige. Svaret kom i en tråd på X, tidigare Twitter, där man redogör för hur blockaden av posten till Tesla stoppar nummerskyltar till nyregistrerade bilar.",
        alternativ: [fortsätt],
        rattSvar: "",
        bild: "bilder/elon.jpeg",
        explainer: "",
    ...
    {
        fraga: "<p>Mats Qviberg. Meningen yttrades 2006 när Qviberg blev intervjuad i ett uppsatsarbete om varför så få kvinnor når toppositioner i näringslivet. Han pudlade senare med förklaringen att ”min fru tyckte jag var klumpig”.</p><p>Mats Qviberg var med och grundade HQ-bank. 2010 förlorade banken sitt tillstånd efter misstankar om bland annat insiderhandel och bokföringsbrott. Mats Qviberg åtalades 2016 för grovt svindleri, men friades av Stockholms tingsrätt.</p>",
        alternativ: [fortsätt],
        rattSvar: "",
        bild: "bilder/elon.jpeg",
        explainer: "",
    ...
    {
        fraga: "Isabella ”Blondbella” Löwengrip. I en intervju i Aftonbladet-TV 2017 att hon skulle kredittesta alla potentiella framtida partners. Enligt henne själv handlade det om självrespekt.",
        alternativ: [fortsätt],
        rattSvar: "",
        bild: "bilder/elon.jpeg",
        explainer: "",
    ...
    {
        fraga: "Leif Östling. Den tidigare hyllade Scania-chefen Leif Östling blev i samband med publiceringen av de så kallade Panamadokumenten påkommen med att ha ett skatteupplägg på Malta. I en intervju med SVT försvarade han sig med att han hade betalat 20-30 miljoner i skatt i Sverige varje år under lång tid.",
        alternativ: [fortsätt],
        rattSvar: "",
        bild: "bilder/elon.jpeg",
        explainer: "",
...
var hem = {
    ...
    view: function() {
        return m("div.container", {id:"container"}, [
            ...
            m("p.textBlock.u-textMetaDeca.u-spacingTopM.speech-bubble", introText),
...
var test = {
    ...
    view: function() {
        return m("div.container", {id:"container"}, [
            ...
            questions[testIndex].meddelande ? m("img.questionImg.u-spacingBottomM", {src: questions[testIndex].bild, id: "image"}) : null,
